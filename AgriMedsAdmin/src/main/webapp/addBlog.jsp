       ...
       <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Blog Title" placeholder="Enter Title To Your Blog " required="required">	
               ...
               <textarea class="form-control"  areaplaceholder="Enter Blog Description" required="required"> </textarea>
                <br>
                <br>
